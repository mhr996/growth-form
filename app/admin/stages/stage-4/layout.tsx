...
const tabs = [
  { name: "تعديل الحقول", href: "/admin/stages/stage-4", icon: Edit },
  { name: "رسالة الترحيب", href: "/admin/stages/stage-4/welcome", icon: Mail },
  {
    name: "رسالة النجاح",
    href: "/admin/stages/stage-4/success",
    icon: CheckCircle2,
  },
  {
    name: "إعدادات المرحلة",
    href: "/admin/stages/stage-4/settings",
    icon: Settings,
  },
];
